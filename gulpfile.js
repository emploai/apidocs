...
const jsFiles = {
   libs: [
      ...
      'node_modules/tocbot/dist/tocbot.js',  //see: https://github.com/emploai/emploai-apidocs/issues/8
   ...
   search: [
      'source/javascripts/lib/_lunr.js',   //see: https://github.com/emploai/emploai-apidocs/issues/9
...
const task = {
   ...
   publishToDocs: () => {
      ...
      fs.writeFileSync('docs/CNAME', 'api.emploai.com\n');
